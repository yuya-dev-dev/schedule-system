...
- 複数セルにまたがる案件では、先頭セルに依頼者名と作業種別を表示し、2セル目以降には矢印を表示する。入庫、商品管理で依頼者名が空の場合は作業種別だけを表示する
...
- 設置、回収、交換、配達は依頼者名と時間範囲、入庫、商品管理は時間範囲と作業種別がそろい、重複がない場合のみ一覧へ反映する
...
| 通常作業の必須項目 | 設置、回収、交換、配達の場合のみ、依頼者名、依頼内容、現場住所、顧客先到着希望時間 |
| 条件付き必須 | 設置、回収、交換、配達で同行ありチェックを付けた場合のみ、集合場所、出発時間 |
