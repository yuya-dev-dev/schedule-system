...
この手順は、Render Free Web ServiceとNeon Free PostgreSQLを使い、実在案件を扱う5人規模の正式運用を対象とする。共通パスワード、Neon接続情報、バックアップ設定ファイル、バックアップ本体、実在案件情報はGit、README、会話、スクリーンショットへ保存しない。
